...
fase_1[0] = [];
fase_1[0]['est'] = '#FFFF00';
fase_1[0]['opt1'] = '#FF8C00';
fase_1[0]['opt2'] = '#FFFF00';
fase_1[0]['itm'] = 1;
fase_1[0]['let'] = 0;
...
fase_1[1] = [];
fase_1[1]['est'] = '#8B4513';
fase_1[1]['opt1'] = '#8B4513';
fase_1[1]['opt2'] = '#FF0000';
fase_1[1]['itm'] = 2;
fase_1[1]['let'] = 0;
...
fase_1[2] = [];
fase_1[2]['est'] = '#0000FF';
fase_1[2]['opt1'] = '#00FF00';
fase_1[2]['opt2'] = '#0000FF';
fase_1[2]['itm'] = 3;
fase_1[2]['let'] = 0;
...
fase_1[3] = [];
fase_1[3]['est'] = '#FF00FF';
fase_1[3]['opt1'] = '#9400D3';
fase_1[3]['opt2'] = '#FF00FF';
fase_1[3]['itm'] = 4;
fase_1[3]['let'] = 0;
...
fase_1[4] = [];
fase_1[4]['est'] = '#FF0000';
fase_1[4]['opt1'] = '#FF0000';
fase_1[4]['opt2'] = '#FF8C00';
fase_1[4]['itm'] = 5;
fase_1[4]['let'] = 0;
...
fase_1[5] = [];
fase_1[5]['est'] = '#00FF00';
fase_1[5]['opt1'] = '#FFFF00';
fase_1[5]['opt2'] = '#00FF00';
fase_1[5]['itm'] = 6;
fase_1[5]['let'] = 0;
...
fase_1[6] = [];
fase_1[6]['est'] = '#9400D3';
fase_1[6]['opt1'] = '#0000FF';
fase_1[6]['opt2'] = '#9400D3';
fase_1[6]['itm'] = 7;
fase_1[6]['let'] = 0;
...
fase_1[7] = [];
fase_1[7]['est'] = '#FF8C00';
fase_1[7]['opt1'] = '#FF8C00';
fase_1[7]['opt2'] = '#FF00FF';
fase_1[7]['itm'] = 8;
fase_1[7]['let'] = 0;
...
class random_fase_1{
    ...
    order_fase_1(arr,inte){
        ...
        for(var k in new_order){
            ...
            document.getElementById('menu'+k+'_opt1').style.backgroundColor = new_order[k]['opt1'];
            document.getElementById('menu'+k+'_opt2').style.backgroundColor = new_order[k]['opt2'];
    ...
    ajax_fase_1(obj){
        ...
        $.ajax({
            ...
            data : {action: 1,user: user_id, data:JSON.stringify(rv), letra: 0, inte: intento},
            type : 'POST',
